...
} from '../src/lib/cryptix-util';

describe('addressToPublicKey', () => {
    it('should be able to round-trip', () => {
        const testAddr = 'cryptix:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq';
    ...
    it('should be able to convert a schnorr-based address to a public key', () => {
        ...
        const address = 'cryptix:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq';
    ...
    it('should be able to convert a p2sh address to a public key', () => {
        ...
        const address = 'cryptix:precqv0krj3r6uyyfa36ga7s0u9jct0v4wg8ctsfde2gkrsgwgw8jgxfzfc98';
    ...
    it('should be able to convert a ECDSA-based address to a public key', () => {
        ...
        const address = 'cryptix:qypdtlw845g6vhgtheug9lpahjgmtpsarqkueeul0sd7t07npfnhe4s7fd82n0v';
...
describe('publicKeyToAddress', () => {
    it('should be able to convert to a schnorr-based address', () => {
        const expectedAddress =
            'cryptix:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq';
    ...
    it('should be able to convert to a p2sh address', () => {
        const expectedAddress =
            'cryptix:precqv0krj3r6uyyfa36ga7s0u9jct0v4wg8ctsfde2gkrsgwgw8jgxfzfc98';
        const publicKey = Buffer.from(
            'f38031f61ca23d70844f63a477d07f0b2c2decab907c2e096e548b0e08721c79',
            'hex',
        );
    ...
    it('should be able to convert to a ECDSA-based address', () => {
        const expectedAddress =
            'cryptix:qypdtlw845g6vhgtheug9lpahjgmtpsarqkueeul0sd7t07npfnhe4s7fd82n0v';
        const publicKey = Buffer.from(
            '02d5fdc7ad11a65d0bbe7882fc3dbc91b5861d182dcce79f7c1be5bfd30a677cd6',
            'hex',
        );
